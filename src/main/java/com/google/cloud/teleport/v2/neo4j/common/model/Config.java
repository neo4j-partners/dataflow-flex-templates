...
public class Config implements Serializable {
    ...
    public Config(final JSONObject jsonObject) {
        ...
        nodeBatchSize = jsonObject.has("node_write_paralellism")?jsonObject.getInt("node_write_paralellism"):nodeBatchSize;
        edgeBatchSize = jsonObject.has("edge_write_paralellism")?jsonObject.getInt("edge_write_paralellism"):edgeBatchSize;
    }
}